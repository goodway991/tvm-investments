...
const contentSecurityPolicy = [
  ...
  "img-src 'self' data: blob: https://morningbrew.com https://www.morningbrew.com https://storage.morningbrew.com https://*.morningbrew.com https://www.google-analytics.com https://www.googletagmanager.com https://*.stripe.com https://cdn.discordapp.com",
  "font-src 'self' data:",
...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      ...
      {
        source: "/:file(icon.png|apple-icon.png|favicon.ico)",
        headers: [
          {
            key: "Cache-Control",
            value: "public, max-age=86400, stale-while-revalidate=604800",
